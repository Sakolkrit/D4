...
\def\dissauthorfour{Mr./Ms. Firstname4 Lastname4}   % 4th member 
\def\dissauthorfive{}   % 5th member (optional)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\dissadvisor{My main TA name}  % Main Teaching Assistant
%%% Leave it empty if you have no Co-advisor
\def\disscoadvisor{My Second TA name}  % the second Teaching Assistant
\def\disscommitteetwo{}  % 3rd committee member (no-need)
\def\disscommitteethree{}   % 4th committee member (no-need) 
\def\disscommitteefour{}    % 5th committee member (no-need) 
...
\def\thaidissauthor{นายสมศักดิ์ คอมพิวเตอร์} % Student 1
\def\thaidissauthortwo{นางสาวสมศรี คอมพิวเตอร์2} % Student 2
\def\thaidissauthorthree{นางสาวสมปอง คอมพิวเตอร์3} % Student 3
\def\thaidissauthorfour{นางสาวสมปอง คอมพิวเตอร์4} % Student 4
\def\thaidissauthorfive{} % Student 5
...
%%OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%           Literature Review (Background Theory and Related Work)          %%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO%%
