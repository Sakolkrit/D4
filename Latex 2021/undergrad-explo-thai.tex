...
\documentclass[12pt,oneside,openright,a4paper]{explo-thai-project}
...
\def\dissauthortwo{Mr./Ms. Firstname2 Lastname2}   % 2nd member 
\def\dissauthorthree{Mr./Ms. Firstname3 Lastname3}   % 3rd member 
\def\dissauthorfour{Mr./Ms. Firstname4 Lastname4}   % 4rd member 
\def\dissauthorfive{}   % 5rd member (optional)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\dissadvisor{}  % Advisor (No-Need)
%%% Leave it empty if you have no Co-advisor (No-Need)
\def\disscoadvisor{}  % Co-advisor (No-Need)
\def\disscommitteetwo{}  % 3rd committee member (optional)
\def\disscommitteethree{}   % 4th committee member (optional) 
\def\disscommitteefour{}    % 5th committee member (optional) 

\def\worktype{Project} %%  Project or Independent study (No-Need)
\def\disscredit{3}   %% 3 credits or 6 credits (No-Need)


\def\fieldofstudy{Computer Engineering} %% (No-Need)
\def\department{Computer Engineering} %% (No-Need)
\def\faculty{Engineering} %% (No-Need)
...
\def\thaiworktype{โครงงาน} %  Course Project % 
\def\thaidisstitleone{หัวข้อปริญญานิพนธ์บรรทัดแรก}
\def\thaidisstitletwo{หัวข้อปริญญานิพนธ์บรรทัดสอง}
\def\thaidissauthor{นายสมศักดิ์ คอมพิวเตอร์} %  นักศึกษา 1
\def\thaidissauthortwo{นางสาวสมศรี คอมพิวเตอร์2} % นักศึกษา 2
\def\thaidissauthorthree{นางสาวสมปอง คอมพิวเตอร์3} % นักศึกษา 3
\def\thaidissauthorfour{นางสาวสมปอง คอมพิวเตอร์4} % นักศึกษา 4
\def\thaidissauthorfive{} % นักศึกษา 5 (Optional)

\def\thaidissadvisor{ชื่อพี่ช่วยสอน ที่ดูแล} % TA Name 1
%% Leave this empty if you have no co-advisor
\def\thaidisscoadvisor{ชื่อพี่ช่วยสอน ที่ดูแลร่วม} % TA Name 2
